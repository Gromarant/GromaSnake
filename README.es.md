<p align="center"><img src="src/assets/images/title_readme.svg" style="width:45%;" alt="Título FullPokeApp"/></p>
...
**2. &nbsp; &nbsp; Tablero:** Es el marco por dónde se mueve la culebra y aparece la comida.<br>
**3. &nbsp; &nbsp; Botón de recarga:** Redirige a la página de inicio para permitir al usuario iniciar un juego nuevo.<br>
**4. &nbsp; &nbsp; Botón de pausa:** Permite al usuario pausar el juego ( **Versión de escritorio:** se puede activar con la barra espaciadora del teclado ).<br><br>
--> así como:
...
<a href="https://developer.mozilla.org/en-US/docs/Web/CSS" target="_blank"><img src="src/assets/images/css_readme_dark_aqua.svg" title="Saber más sobre CSS" alt="CSS"/></a> &nbsp; &nbsp;
